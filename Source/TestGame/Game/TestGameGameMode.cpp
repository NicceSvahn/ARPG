...
void ATestGameGameMode::BeginPlay()
{
    ...
    // The generator is a placed actor in the persistent map.
    ...
    LevelGenerator->OnGeneratedMapReady.AddUObject(
        this,
        &ATestGameGameMode::HandleGeneratedMapReady
    );
...
void ATestGameGameMode::RestartPlayer(
...
void ATestGameGameMode::HandleGeneratedMapReady()
{
...
bool ATestGameGameMode::HasGroundAtPlayerStart(
    AController* Player
)
{
...
void ATestGameGameMode::EndPlay(
